...
<?php include "_includes/nav.php" ?>
	...
	<img class="p-img-4 large" src="_images/industrial.jpg" border="0" width="100%"><img class="p-img-4 small" src="_images/industrial.jpg" border="0" width="100%">
	<div class="credentials">
		<p class="header-p">Industrial Program and Construction Management</p>
		<p class="subsequent-p">Program and Construction Management: While form is important, function drives the project.  Providing clearer direction from design intent to a constructible solution where fiduciary responsibility needs to understand the balance of risk and affordability.</p> 
		<ul>
